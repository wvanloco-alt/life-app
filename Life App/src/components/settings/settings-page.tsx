...
import { Users, Dumbbell, Clock, Watch, Mail, KeyRound } from "lucide-react";
...
const SECTIONS = [
  ...
  },
  {
    ...
    description: "Auto-import activities, sleep, and daily calories",
  ...
  {
    title: "Email digest",
    description: "A warm morning briefing — sleep, training, habits",
    href: "/settings/email",
    icon: Mail,
    color: "#C2813A",
  },
